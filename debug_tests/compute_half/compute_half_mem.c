...
/*@
 ...
 context (\forall* int _0, int _1; 0 <= _0 && _0 < 100 && 0 <= _1 && _1 < 42; {:out_pred(_out_buffer->host, _0, 0, 100, _1, 0, 42):});
@*/
int compute_half_mem(struct halide_buffer_int32_t *_out_buffer) {
 ...
 // produce out
 /*@
  loop_invariant 0 <= _out_s0_y && _out_s0_y <= 0 + 42;
  loop_invariant (\forall* int _out_s0_y_forall, int _out_s0_x_forall; 0 <= _out_s0_y_forall && _out_s0_y_forall < 42 && 0 <= _out_s0_x_forall && _out_s0_x_forall < 100; {:out_pred(_out, _out_s0_x_forall, 0, 100, _out_s0_y_forall, 0, 42):});
 @*/
 for (int _out_s0_y = 0; _out_s0_y < 0 + 42; _out_s0_y++)
 {
  {
   int32_t _f[100];
   //@ ghost to_pred(_f, 0, 100, _out_s0_y, 1);
   // produce f
   /*@
    loop_invariant 0 <= _f_s0_x && _f_s0_x <= 0 + 100;
    loop_invariant (\forall* int _f_s0_x_forall; 0 <= _f_s0_x_forall && _f_s0_x_forall < 100; {:f_pred(_f, _f_s0_x_forall, 0, 100, _out_s0_y, _out_s0_y, 1):});
   @*/
   for (int _f_s0_x = 0; _f_s0_x < 0 + 100; _f_s0_x++)
   {
    /*@
     unfold f_pred(_f, _f_s0_x, 0, 100, _out_s0_y, _out_s0_y, 1); @*/
    _f[_f_s0_x]= (_f_s0_x + _out_s0_y);
    /*@ fold f_pred(_f, _f_s0_x, 0, 100, _out_s0_y, _out_s0_y, 1); @*/
   } // for _f_s0_x
   // consume f
   //@ ghost converse_pred(_f, 0, 100, _out_s0_y, 1);
   int32_t _t2 = (_out_s0_y * 100);
   /*@
    loop_invariant 0 <= _out_s0_x && _out_s0_x <= 0 + 100;
    loop_invariant [1\2]_int32_pred(_f);
    //loop_invariant (\forall* int _f_s0_x, int _f_s0_y; 0 <= _f_s0_x && _f_s0_x <= 99 && _out_s0_y <= _f_s0_y && _f_s0_y <= _out_s0_y; {:f_pred(_f, _f_s0_x, 0, 100, _f_s0_y, _out_s0_y, 1):});
    loop_invariant (\forall* int _out_s0_x_forall; 0 <= _out_s0_x_forall && _out_s0_x_forall < 100; {:out_pred(_out, _out_s0_x_forall, 0, 100, _out_s0_y, 0, 42):});
   @*/
   for (int _out_s0_x = 0; _out_s0_x < 0 + 100; _out_s0_x++)
   {
    int32_t _1 = 
    /*@ with
     unfold [1\2]_int32_pred(_f); @*/
     _f[_out_s0_x]
    /*@ then
     fold [1\2]_int32_pred(_f); @*/
    ;
    /*@
     unfold out_pred(_out, _out_s0_x, 0, 100, _out_s0_y, 0, 42); @*/
    _out[(_out_s0_x + _t2)]= (_1 + 1);
    /*@ fold out_pred(_out, _out_s0_x, 0, 100, _out_s0_y, 0, 42); @*/
   } // for _out_s0_x
  } // alloc _f
 } // for _out_s0_y
 return 0;
